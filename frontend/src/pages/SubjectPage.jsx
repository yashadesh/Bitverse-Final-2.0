...
import { HeaderSkeleton, ModuleCardSkeleton, FileCardSkeleton } from "@/components/Skeletons";
        ...
        <section className="mt-16">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 shrink-0 animate-shimmer" />
